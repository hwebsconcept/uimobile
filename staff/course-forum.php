  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
		...
		<div class="col-md-12">
            <h3>COURSE FORUM OPTION</h3>

            <div class = "col-md-12" style="background: #efefef; border-radius:20px; padding:20px; margin-top:30px;" align="center">
                <h2>CHOOSE AN COURSE</h2>
                <button class="btn btn-default" data-toggle="modal" data-target="#myModal"><i class="fa fa-plane"></i> VIEW FORUM</button>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="get" enctype="multipart/form-data" action="view-course-forum.php" name="change_pwd" id="change_pwd" role="form">
