...
if(isset($_POST['create']))
{
	...
	$check = mysql_query ("SELECT * FROM notification WHERE notificationTitle ='$sub' AND audience='$aud'");
	...
	{
		$query=mysql_query("INSERT INTO notification (audience, notificationTitle, notificationContent) 
		VALUES ('$aud','$sub','$content')");
		if ($query)
		{
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
		...
		<form action="" method="post" enctype="multipart/form-data" name="form2" id="form2">
			<div class="col-md-12">
				<input name="audience" type="text" required placeholder="Audience" class="form-control"><br>
