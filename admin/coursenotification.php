...
if(isset($_POST['create']))
{
	...
	$check = mysql_query ("SELECT * FROM coursenotification WHERE notificationTitle ='$sub' AND courseCode='$ccode'");
	...
	{
		$query=mysql_query("INSERT INTO coursenotification (courseCode, notificationTitle, notificationContent) 
		VALUES ('$ccode','$sub','$content')");
		if ($query)
		{
...
<html lang="en">
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
		<div class="col-md-12" >
			<a href="view-coursenotification.php"><button class="btn btn-default">GO BACK</button></a>
		...
		<form action="" method="post" enctype="multipart/form-data" name="form2" id="form2">
			<div class="col-md-12">
				<input name="coursecode" type="text" required placeholder="Course Code" class="form-control"><br>
				<input name="subject" type="text" required placeholder="Subject" class="form-control"><br>
				<input name="content" type="text" required placeholder="Content" class="form-control"><br>
			</div>
			<div class="col-md-6">
