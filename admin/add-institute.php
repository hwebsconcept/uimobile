...
if(isset($_POST['create']))
{
	...
	$check = mysql_query ("SELECT * FROM institute WHERE matric ='$mat'");
	...
	{
		$query=mysql_query("INSERT INTO institute (matric, school, department, faculty, cumGPA, currentGPA) 
		VALUES ('$mat','$school','$department','$faculty','$cumGPA','$currentGPA')");
		if ($query)
		{
...
<html lang="en">
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
		<div class="col-md-12" >
			<a href="view-institute.php"><button class="btn btn-default">GO BACK</button></a>
			<a href="add-institute.php"><button class="btn btn-primary">ADD NEW</button></a>
			</div>
			<div class="col-md-12">
		...
		<form action="" method="post" enctype="multipart/form-data" name="form2" id="form2">
			<div class="col-md-12">
				...
				<input name="school" type="text" required placeholder="School" class="form-control"><br>
				<input name="department" type="text" required placeholder="Department" class="form-control"><br>
				<input name="faculty" type="text" required placeholder="Faculty" class="form-control"><br>
				<input name="cumGPA" type="text" required placeholder="cumulative GPA" class="form-control"><br>
				<input name="currentGPA" type="text" required placeholder="current GPA" class="form-control"><br>
			</div>
			<div class="col-md-6">
