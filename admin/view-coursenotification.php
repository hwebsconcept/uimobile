...
if (isset($_GET['id']))
{
	$e= mysql_query ("DELETE FROM coursenotification WHERE id=".$_GET['id']."");
	if ($e)
	{
	$msg="Deleted";
	}
...
<html lang="en">
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
		<div class="col-md-12">
			<a href="add-coursenotification.php"><button class="btn btn-success">ADD COURSE NOTIFICATION</button></a>
		</div>
		<div class="col-md-12">
			<h3>VIEW STUDENTS</h3>
		...
		<table class="table table-bordered">
			...
			<?php
			$a=mysql_query ("SELECT * FROM coursenotification ORDER BY id DESC");
			...
			<tr>
				<td><?php echo $b['id'] ?></td>
				<td><?php echo ucfirst($b['courseCode']) ?></td>
