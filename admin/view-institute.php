...
if (isset($_GET['id']))
{
	$e= mysql_query ("DELETE FROM institute WHERE id=".$_GET['id']."");
	if ($e)
	{
	$msg="Deleted";
	}
...
<html lang="en">
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
		<div class="col-md-12">
			<a href="add-institute.php"><button class="btn btn-success">ADD MORE PROFILE</button></a>
		</div>
		<div class="col-md-12">
			<h3>VIEW STUDENTS</h3>
		...
		<table class="table table-bordered">
			...
			<?php
			$a=mysql_query ("SELECT * FROM institute ORDER BY id DESC");
			...
			<tr>
				...
				<td><?php echo $b['school'] ?></td>
				<td><?php echo $b['department'] ?></td>
				<td><?php echo $b['faculty'] ?></td>
				<td><?php echo $b['cumGPA'] ?></td>
				<td><?php echo $b['currentGPA'] ?></td>
