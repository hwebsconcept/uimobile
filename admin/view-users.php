...
if (isset($_GET['id']))
{
	$e= mysql_query ("DELETE FROM users WHERE id=".$_GET['id']."");
	if ($e)
	{
	$msg="Deleted";
	}
...
<html lang="en">
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
		<div class="col-md-12">
			<a href="add-users.php"><button class="btn btn-success">ADD NEW STUDENT</button></a>
		</div>
		<div class="col-md-12">
			<h3>VIEW STUDENTS</h3>
		...
		<table class="table table-bordered">
			...
			<?php
			$a=mysql_query ("SELECT * FROM users ORDER BY id DESC");
			...
			<tr>
				<td><?php echo $b['id'] ?></td>
				<td><?php echo ucfirst($b['firstName']) ?> <?php echo ucfirst($b['lastName']) ?></td>
				<td><?php echo $b['matric'] ?></td>
				<td><?php echo $b['password'] ?></td>
				<td><?php echo $b['email'] ?></td>
				<td><?php echo $b['phone'] ?></td>
				<td><img src="<?php echo $b['img'] ?>" style="max-width:70px;" /></td>
				<td><a href="edit-project.php?id=<?php echo $b['id'] ?> "><button class="btn btn-sm btn-default">Edit</button> </a></td>
				<td><a href="view-users.php?id=<?php echo $b['id'] ?> "><button class="btn btn-sm btn-warning">Delete</button> </a></td>
